...
bilateral=cv2.bilateralFilter(img,9,75,75)    #The 1st arg is source,2nd arg is diameter of each pixel neighbourhood used during filter
                                              #3rd arg is sigma color and 4th arg is sigma space
                                              #Sigma color is filter sigma in color space and sigma space is filter sigma in coordinate space
                                              
image=[img,dst,blur,gblur,median,bilateral]
titles=['Original','Homogenous Filter','Blurred Image','Gaussian Blur','Median Filter','Bilateral Filter']
